---
title: "创建博客技术分析"
pubDatetime: 2025-04-17T23:56:55+08:00
draft: false
featured: false
tags:
  - blog
  - hexo
  - github-pages
description: "个人博客搭建技术对比与实现细则，包括 Hexo + GitHub Pages 和 WordPress 两种方案"
---
...
![展示图](https://cdn.jsdelivr.net/gh/WyiZhng/ImgHosting/Blog-PIC/1.png)
...
![配置图](https://cdn.jsdelivr.net/gh/WyiZhng/ImgHosting/Blog-PIC/2.png)
...
![ssh设置](https://cdn.jsdelivr.net/gh/WyiZhng/ImgHosting/Blog-PIC/3.png)

此时，本地和Github的工作做得差不了，是时候把它们两个链接起来了。你也能够查看官网的部署教程。先不着急，部署以前还须要修改配置和安装部署插件。第一：打开项目根目录下的 `_config.yml` 配置文件配置参数。拉到文件末尾，填上以下配置

![部署配置](https://cdn.jsdelivr.net/gh/WyiZhng/ImgHosting/Blog-PIC/4.png)
...
4-22日补充：在博客上传方案上一直在typora修改对应的链接但是都没办法显示链接，可能是github的问题，上传照片到github仓库上也不行，甚至是直接GitHub上看图片都丢失了。综上通过这篇优秀的博客：[https://blog.csdn.net/prefectjava/article/details/111192741](https://blog.csdn.net/prefectjava/article/details/111192741)

实现了picgo以github做图床，总之，这篇文章很好，并且将hexo+githubpage+picgo的技术都进行了很好的叙述！
